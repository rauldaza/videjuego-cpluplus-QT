...
struct qt_meta_stringdata_rick_t {
    QByteArrayData data[1];
    char stringdata0[5];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_rick_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_rick_t qt_meta_stringdata_rick = {
    {
QT_MOC_LITERAL(0, 0, 4) // "rick"
...
static const uint qt_meta_data_rick[] = {
...
QT_INIT_METAOBJECT const QMetaObject rick::staticMetaObject = { {
    QMetaObject::SuperData::link<heroe::staticMetaObject>(),
    qt_meta_stringdata_rick.data,
    qt_meta_data_rick,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *rick::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_rick.stringdata0))
